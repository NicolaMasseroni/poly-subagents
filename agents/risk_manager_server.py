"""A2A server for the Risk Manager sub-agent."""
...
AGENT_URL = os.getenv("RISK_MANAGER_URL", "http://localhost:8080")
...
def build_app() -> Starlette:
    card = AgentCard(
        name="Risk Manager",
        description="Valutazione rischio bet Polymarket contro limiti correnti",
        version="1.0.0",
        skills=[AgentSkill(id="risk-assessment", name="Risk Assessment")],
    ...
    handler = DefaultRequestHandler(
        agent_card=card,
        agent_executor=RiskManagerExecutor(),
